...
if (isset($_POST['submitir'])) {
	...
	if (emptyInputSignup($nombre, $apellido, $email, $nucuenta, $numtelefono, $pwd, $confpwd) !== false) {
	...
	crearUsuario($conn, $nombre, $apellido, $nucuenta, $numtelefono , $email, $pwd);
}else{
