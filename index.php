						...
						<form action="includes/login.inc.php" method="post" id="form-login">
							...
							<div class="list block">
								...
								<ul>
									...
									<li>
										<div class="block-footer"><a href="#"
												class="login-screen-open button button-fill"
												data-login-screen="#modal-registro" id="btnRegistro">Regístrate
												aquí</a>
										</div>
									</li>
								</ul>
								...
								<div class="list">
									...
									<li class="item-content item-input">
										<div class="item-inner">
											...
											<div class="item-input-wrap">
												<input type="text" name="numcuenta" placeholder="1111111" required>
												<span class="input-clear-button"></span>
											</div>
										</div>
									</li>
									<li class="item-content item-input">
										<div class="item-inner">
											<div class="item-title item-label">Correo Institucional</div>
											<div class="item-input-wrap">
												<input type="text" name="correo" placeholder="example@unitec.edu"
													required>
												<span class="input-clear-button"></span>
											</div>
										</div>
